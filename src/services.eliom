...
module Frontend = 
  struct
    ...
    let challenge_new_post = post_service challenge_new (string "author" ** string "title" ** string "description" ** string "difficulty" ** string "hints") () (* add tags + control_code file sending, and maybe create facebook comment *)
